...
function Sidebar({
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "text-primary-dark bg-primary-50 flex h-full w-(--sidebar-width) flex-col",
          className,
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="text-primary-dark bg-primary-50 w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    <div
      className="group peer text-primary-dark hidden md:block"
      data-state={state}
    ...
    >
      ...
      >
        <div
          ...
          className="group-data-[variant=floating]:ring-border bg-primary-50 flex size-full flex-col group-data-[variant=floating]:rounded-xl group-data-[variant=floating]:shadow-md group-data-[variant=floating]:ring-0"
        >
          {children}
        </div>
      </div>
...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          "select-none text-primary-dark/80 uppercase tracking-wider ring-sidebar-ring h-8 rounded-md px-2 text-xs font-medium transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:hidden focus-visible:ring-2 [&>svg]:size-4 flex shrink-0 items-center outline-hidden [&>svg]:shrink-0",
          className,
        ),
      },
      props,
...
export const sidebarMenuButtonVariants = cva(
  "active:bg-primary-100 active:text-foreground data-active:bg-sidebar-accent data-active:text-sidebar-accent-foreground data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground gap-2 rounded-xl px-3 py-2 text-left text-sm transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! focus-visible:ring-2 data-active:font-medium peer/menu-button flex w-full items-center overflow-hidden outline-hidden group/menu-button disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0 transition-colors duration-100 ease-linear select-none",
  {
    variants: {
      variant: {
        default: "hover:bg-primary-100 hover:text-foreground",
        outline:
