...
import { deleteOperatorInviteAction, revokeOperatorInviteAction } from "../actions";
...
export function OperatorInviteActions({ inviteId, inviteEmail, disabled = false }: Props) {
    ...
    startTransition(async () => {
      const result =
        confirmAction === "revoke"
          ? await revokeOperatorInviteAction(inviteId)
          : await deleteOperatorInviteAction(inviteId);
